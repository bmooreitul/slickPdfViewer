...
class Toolbar {
  ...
  #bindListeners(buttons) {
    ...
    document.getElementById('scaleSelectInput').addEventListener('blur', function(){
    ...
    scaleSelect.addEventListener("change", function () {
      document.getElementById('scaleSelectInput').value = self.pageScale
