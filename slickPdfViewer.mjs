...
};
{
  ...
  defaultOptions.defaultFileName = {
    value: null,
    kind: OptionKind.VIEWER
  };

  defaultOptions.defaultWrapper = {
    value: null,
    kind: OptionKind.VIEWER
  };

  defaultOptions.uniqueId = {
    value: Date.now().toString(36)+Math.random().toString(36).substring(2, 12).padStart(12, 0),
    kind: OptionKind.VIEWER
  };
...
class Toolbar {
  ...
  constructor(options, eventBus, toolbarDensity = 0) {
    ...
    {
      element: options.pageFitHeightButton,
      eventName: "fitpageheight",
      eventDetails: {
      	pageFitWidthButton: options.pageFitWidthButton,
      	pageFitHeightButton: options.pageFitHeightButton,
      }
    },

    {
      element: options.pageFitWidthButton,
      eventName: "fitpagewidth",
      eventDetails: {
      	pageFitWidthButton: options.pageFitWidthButton,
      	pageFitHeightButton: options.pageFitHeightButton,
      }
    ...
    {
      element: options.pageRotateButton,
      eventName: "rotateccw"
    },
  ...
  #bindListeners(buttons) {
    ...
    scaleSelectInput.addEventListener('blur', function(){

      var value = this.value.length ? Number(this.value)/100 : self.pageScale;
    ...
    scaleSelect.addEventListener("change", function () {
      scaleSelectInput.value = self.pageScale
  ...
  #updateUIState(resetNumPages = false) {
    ...
    document.getElementById('scaleSelectInput').value = Math.round(pageScale*100);
...
const PDFViewerApplication = {
  ...
  load(pdfDocument) {
    ...
    const storedPromise = (this.store = new ViewHistory(pdfDocument.fingerprints[0])).getMultiple({
      ...
      scrollTop: "0",
      rotation: null,
      sidebarView: slickPdfViewDefaults.thumbnails === true ? 1 : (slickPdfViewDefaults.thumbnails === false ? 0 : SidebarView.UNKNOWN),
  ...
  async _initializeMetadata(pdfDocument) {
    ...
    if(AppOptions.get('defaultFileName')){
    	this._title = AppOptions.get('defaultFileName');
    	this._contentDispositionFilename = AppOptions.get('defaultFileName');
    	this.setTitle(AppOptions.get('defaultFileName'));
    }
    else if (pdfTitle) {
  ...
  bindEvents() {
    ...
    eventBus._on("fitpageheight", this.fitPageHeight.bind(this), opts);
    eventBus._on("fitpagewidth", this.fitPageWidth.bind(this), opts);
...
function onResize() {
  ...
  //document.getElementById('scaleSelectInput').value = Math.round(currentScaleValue*100);
  pdfViewer.update();
}
...
var slickPdfViewDefaultsConfigMap = {
	//appContainer :
}
...
function getViewerConfiguration() {
  ...
  return {
    ...
    toolbar                       	: {
      ...
      scaleSelectInput 				: document.getElementById('scaleSelectInput'),
      customScaleOption           	: document.getElementById("customScaleOption"),
      previous                    	: document.getElementById("previous"),
      next                        	: document.getElementById("next"),
      zoomIn                      	: document.getElementById("zoomInButton"),
      zoomOut                     	: document.getElementById("zoomOutButton"),
      pageRotateButton				: document.getElementById("pageRotateButton"),
      pageFitHeightButton 			: document.getElementById("pageFitHeightButton"),
      pageFitWidthButton 			: document.getElementById("pageFitWidthButton"),
...
window.slickPdfView = function(wrapperSelector, options){
	...
	if(typeof options == 'string') options = {fileUrl: options};

	var uniqueId = typeof options.uniqueId == 'undefined' ? Date.now().toString(36)+Math.random().toString(36).substring(2, 12).padStart(12, 0) : options.uniqueId;
...
<div id="outerContainer">
          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer" class="toolbarHorizontalGroup">
              <div id="toolbarViewerLeft" class="toolbarHorizontalGroup" style="padding-left:20px;">
                ...
                <div id="viewer-title" class="hiddenSmallView" style="color:var(--main-color); margin-left:16px;"></div>
              ...
              <div id="toolbarViewerMiddle" class="toolbarHorizontalGroup">
                <div class="toolbarHorizontalGroup hiddenMediumView" style="margin-right:20px;">
                  <span class="loadingInput start toolbarHorizontalGroup">
                    <input type="number" id="pageNumber" class="toolbarField" name="not-an-email" title="Page" value="1" min="1" tabindex="0" data-l10n-id="pdfjs-page-input" autocomplete="hidden">
                  </span>
                ...
                <div class="toolbarHorizontalGroup hiddenSmallView">
	                ...
	                <span id="scaleSelectContainer" class="dropdownToolbarButton hidden">
	                  ...
	                  <select id="scaleSelect" title="Zoom" tabindex="0" data-l10n-id="pdfjs-zoom-select">
	                    <option id="pageAutoOption" title="" value="auto" selected="selected" data-l10n-id="pdfjs-page-scale-auto">Auto</option>
	                    <option id="pageActualOption" title="" value="page-actual" data-l10n-id="pdfjs-page-scale-actual">Actual</option>
                	...
                	<span style="position:relative">
                		<input type="number" id="scaleSelectInput" class="toolbarField" title="Page Scale" data-l10n-id="pdfjs-zoom-select-input" style="width:40px; text-align:center; padding-right:16px;" value="" min="1" max="400" autocomplete="hidden">
                		<span style="color:rgba(255,255,255,0.3); position:absolute; right:5px; top:3px; font-size:12px; line-height:24px;">%</span>
                	</span>
                ...
                <div class="toolbarHorizontalGroup hiddenMediumView" style="margin-left:12px;">
                	<button id="pageFitHeightButton" class="toolbarButton" type="button" title="Fit To Page" tabindex="0" data-l10n-id="pdfjs-page-fit-height-button">
                    	<span data-l10n-id="pdfjs-page-fit-height-button-label">Fit To Page</span>
                  	</button>

                  	<button id="pageFitWidthButton" class="toolbarButton hidden" type="button" title="Fit To Width" tabindex="0" data-l10n-id="pdfjs-page-fit-width-button">
                    	<span data-l10n-id="pdfjs-page-fit-width-button-label">Fit To Width</span>
                  	</button>

                  	<button id="pageRotateButton" class="toolbarButton" type="button" title="Rotate Counterclockwise" tabindex="0" data-l10n-id="pdfjs-page-rotate-button">
                    	<span data-l10n-id="pdfjs-page-rotate-button-label">Rotate Counterclockwise</span>
                  	</button>
                </div>
                ...
                <div id="secondaryToolbarToggle" class="toolbarButtonWithContainer" style="display:flex; align-items:center">
                  ...
                  <div id="secondaryToolbar" class="hidden doorHangerRight menu">
                    <div id="secondaryToolbarButtonContainer" class="menuContainer">
                      ...
                      <button id="firstPage" class="toolbarButton labeled hidden" type="button" title="Go to First Page" tabindex="0" data-l10n-id="pdfjs-first-page-button">
                        <span data-l10n-id="pdfjs-first-page-button-label">Go to First Page</span>
                      </button>
                      <button id="lastPage" class="toolbarButton labeled hidden" type="button" title="Go to Last Page" tabindex="0" data-l10n-id="pdfjs-last-page-button">
                      ...
                      <div id="cursorToolButtons hidden" role="radiogroup">
                        ...
                        <button id="cursorHandTool" class="toolbarButton labeled hidden" type="button" title="Enable Hand Tool" tabindex="0" data-l10n-id="pdfjs-cursor-hand-tool-button" role="radio" aria-checked="false">
    ...
    if(slickPdfViewDefaults.thumbnails === true || slickPdfViewDefaults.thumbnails === false){
...
if (document.readyState === "interactive" || document.readyState === "complete") {
  //webViewerLoad();
  var fileUrl = parseQueryString(new URL(import.meta.url).search.substring(1)).get('file');
  if(fileUrl) window.slickPdfView(fileUrl);
  //console.log(fileUrl);
} else {
  //document.addEventListener("DOMContentLoaded", webViewerLoad, true);
}
*/
window.slickPdfViewConfig = slickPdfViewDefaults;
...
const slickPdfModuleReadyEvent = new CustomEvent("module.sp.ready", {
	bubbles: true,
	cancelable: true,
	detail: {
 	source: window
...
try {
	parent.document.dispatchEvent(slickPdfModuleReadyEvent);
} catch (ex) {
	document.dispatchEvent(slickPdfModuleReadyEvent);
}
